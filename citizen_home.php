...
<body>
    ...
    <div class="container-md my-4 p-2">
        <form class="d-flex my-1" action="citizen_home.php" method="POST">
            <input class="form-control me-2" type="search" placeholder="Enter any report title, status, crime or date (YYYY-MM-DD)" aria-label="Search" name="search" >
